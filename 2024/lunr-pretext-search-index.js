...
},
{
  ...
  "number": "1.1.15",
  "title": "",
  "body": "  A system of linear equations with variables is often represented by writing its coefficients and constants in an augmented matrix . augmented matrix    Often, we will want to refer only to the coefficients of the linear system; the coefficient matrix coeefficient matrix is the array consisting of these coefficients:   "
},
{
  "id": "example-2",
  "level": "2",
...
},
{
  ...
  "number": "1.2.7",
  "title": "",
  "body": "  Recall that a matrix is in reduced row echelon form ( RREF ) if   Each pivot (leftmost nonzero term of a row) is equal to 1.  Each pivot is to the right of every higher pivot.  Each term that is either above or below a pivot is 0.  All zero rows (rows whose terms are all 0) are at the bottom of the matrix.   For each matrix, mark the leading terms, and label it as RREF or not RREF. For the ones not in RREF, determine which rule is violated and how it might be fixed.        "
},
{
  "id": "activity-8",
  "level": "2",
...
},
{
  ...
  "number": "2.3.4",
  "title": "",
  "body": "  Consider the homogeneous vector equation .    Note that if and are both solutions, we know that . Adding these equations, we obtain:  Therefore, we may conclude that the vector is...   another solution.    not a solution.    is equal to .    Similarly, if , then since multiplying by yields: we may conclude that the vector is...   another solution.    not a solution.    is equal to .    Is this equation consistent?   no.    yes.    more information is required.    "
},
{
  "id": "observation-6",
  "level": "2",
...
},
{
  ...
  "number": "2.6.1",
  "title": "",
  "body": " Recall from section that a subspace of a vector space is a non-empty subset that is closed under vector addition and scalar multiplication. If is a set of vectors in , we observed that is a subspace of .  Recall also that a linearly dependent set contains redundant vectors. For example, only two of the three vectors in are needed to span the planar subspace.  "
},
{
  "id": "activity-56",
  "level": "2",
...
},
{
  ...
  "number": "2.6.3",
  "title": "",
  "body": "  Let be a subspace of a vector space. A basis for is a linearly independent set of vectors that spans (but not necessarily the entire vector space). That is, for the set to be a basis of , we are saying two things:   The set is linearly independent.    We have .      "
},
{
  "id": "observation-11",
  "level": "2",
...
},
{
  ...
  "number": "3.3.4",
  "title": "",
  "body": "  Let be the linear transformation given by the standard matrix .    Compute .   Set to find a linear system of equations whose solution set is the kernel.  Use to solve this homogeneous system of equations and find a basis for the kernel of .  "
},
{
  "id": "activity-81",
  "level": "2",
...
},
{
  ...
  "number": "3.6.4",
  "title": "",
  "body": "  Let be a vector space with the basis . Consider the following linear transformations : where is which of the following:       Which of them are bijective?   "
},
{
  "id": "fact-17",
  "level": "2",
...
},
{
  ...
  "number": "B.1.1",
  "title": "LE1.",
  "body": " LE1   Consider the scalar system of equations    Rewrite this system as a vector equation.  Write an augmented matrix corresponding to this system.      A vector equation corresponding to the given system of equations is given by:    An augmented matrix corresponding to the given system of equations is given by:     "
},
{
  "id": "sample-LE2",
  "level": "2",
...
},
{
  ...
  "number": "B.1.7",
  "title": "EV3.",
  "body": "EV3   Consider the following two sets of Euclidean vectors. Explain why one of these sets is a subspace of , and why the other is not.    To show that is a subspace, first note that it is nonempty as , since . Then let and , so we know that and .  Consider To see if , we need to check if . We compute Thus , so is closed under vector addition.  Now consider Similarly, to check that , we need to check if , so we compute and we see that , so is closed under scalar multiplication. Therefore is a subspace of .  Now, to show is not a subspace, we will show that it is not closed under scalar multiplication. Note that the vector belongs to since . However, the vector does not belong to since . Therefore is not closed under scalar multiplication, and thus is not a subspace.   "
},
{
  "id": "sample-EV4",
  "level": "2",
